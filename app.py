...
with tab1:
    ...
    it_data = [
        ...
        {"Fecha": "31 Dic", "Trayecto": "Año Nuevo (BC)", "Hospedaje": "Balneário Camboriú", "Plan": "Reveillón de gala con fuegos artificiales en la playa."},
...
# --- PESTAÑA: RECORRIDO (MAPA AJUSTADO) ---
with tab_map:
    ...
    # Centramos la imagen y limitamos su ancho para que no sea gigante
    col_map1, col_map2, col_map3 = st.columns([1, 5, 1])
    with col_map2:
        st.image(url_mapa, caption="Circuito oficial: SP - Sur - Río - Petrópolis - Minas - SP", width=800)
...
# --- PESTAÑA 3: BIANCA Y MATI (IMÁGENES PERSONALIZADAS) ---
with tab3:
    st.header("🎢 Gritos y Adrenalina en Beto Carrero World")
    st.write("Dos días enteros para que Bianca y Mati no dejen nada sin probar.")
    ...
    st.write("---")
    st.markdown("### 🎯 Los Desafíos Más Extremos")

    col_park1, col_park2 = st.columns(2)

    with col_park1:
        st.image("https://raw.githubusercontent.com/CamiloBarreroC/brasil-app-familiar/main/img/firewhip_bianca.jpg", caption="FireWhip: ¡Solo para valientes como Bianca!", use_container_width=True)
        st.image("https://raw.githubusercontent.com/CamiloBarreroC/brasil-app-familiar/main/img/big_tower_caida.jpg", caption="Big Tower: 100 metros de adrenalina", use_container_width=True)

    with col_park2:
        st.image("https://raw.githubusercontent.com/CamiloBarreroC/brasil-app-familiar/main/img/hot_wheels_mati.jpg", caption="Hot Wheels Epic Show: ¡El favorito de Mati!", use_container_width=True)
        st.image("https://raw.githubusercontent.com/CamiloBarreroC/brasil-app-familiar/main/img/star_mountain_loop.jpg", caption="Star Mountain: El doble loop clásico", use_container_width=True)
        ...
        if st.button("🚀 GUARDAR COTIZACIÓN"):
            if nombre_item and st.session_state.usd_input > 0:
                try:
                    ...
                    st.error("Hubo un problema al conectar con Google Sheets.")
